...
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1 d-flex flex-column justify-content-center">

  <!-- Logo -->
  <div class="mb-4" style="text-indent: -30px;">
    <img src="assets/img/sit-slution-logo.png" alt="CRM Logo" class="img-fluid" style="max-width: 380px;">
  </div>

  <!-- Heading -->
  <h2 class="fw-bold mb-3">Welcome to <span class="" style="color: #383E6D;">CRM</span></h2>

  <!-- Sign Up Link -->
  <p class="fw-semibold">
    New here?  
    <a href="registration.php" class="text-black fw-bold text-decoration-none ">Sign up Now!</a>  
